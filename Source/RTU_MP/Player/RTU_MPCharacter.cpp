...
ARTU_MPCharacter::ARTU_MPCharacter()
{
	...
	GetCharacterMovement()->bUseControllerDesiredRotation = true; // Forces the character to be where the camera is facing 
...
void ARTU_MPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARTU_MPCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ARTU_MPCharacter::Look);
	}
	else
	{
...
void ARTU_MPCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARTU_MPCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
